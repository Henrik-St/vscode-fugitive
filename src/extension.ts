...
export function activate({ subscriptions }: vscode.ExtensionContext): void {
	...
	add_subscription(() => thenable_to_promise(vscode.commands.executeCommand('git.stashStaged')), 'fugitive.stashStaged');
	add_subscription(() => thenable_to_promise(vscode.commands.executeCommand('git.stashPopLatest')), 'fugitive.popLatestStash');
	add_subscription(() => thenable_to_promise(vscode.commands.executeCommand('git.stashPop')), 'fugitive.popStash');
	add_subscription(() => thenable_to_promise(vscode.commands.executeCommand('git.checkout')), 'fugitive.checkoutBranch');
