...
export function activate({ subscriptions }: vscode.ExtensionContext) {
	...
	addSubscription(provider!.stageFile, 'fugitive.stageFile');
	addSubscription(provider!.unstageFile, 'fugitive.unstageFile');
	...
	addSubscription(() => thenableToPromise(vscode.commands.executeCommand('git.refresh')), 'fugitive.refresh');
